...
- [x] 테스트 코드 내 "StarCoder3" 문자열 전체를 "Sm_AICoder"로 변경
...
- [x] 폴더 트리를 VS Code처럼 열기/접기 가능하게 개선
...
- [ ] Python/Node/Java/C++ 프레임워크별 스캐폴드 확장
- [ ] 생성된 프로젝트 자동 .sln/.csproj/패키지 파일 보강
- [ ] GUI 트리 자동 확장/선택 동작 추가 검증
